...
<a class="am-fl ws-nav-loginA" href="{$config_siteurl}register"> 注册</a>
     ...
     <?php }else{ ?>
        ...
        <div class="ws-nav-headmap">
         <img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-avatar-niu.gif'; ?>'" src="<?php echo src_www_to_img('/d/file/avatar/'. $userid . '/30x30.jpg', C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG')).C('AVATARUPDATETIMESTAMP'); ?>" alt="" id="menu-avatar">
        </div>
        <div class="ws-nav-users">
                        ...
                        <a href="http://www.d1ev.com/member/comments/index.html" class="ws-nav-usersA">我的评论</a>
...
<div class="ws-head am-cf am-container">
	<a href="http://www.d1ev.com/" class="ws-head-a am-fl ">
...
<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://www.d1ev.com/new2016/src/public/images/ws-banner.jpg" alt="" />
</div>
<div class="blank10"></div>
...
<dl class="ws-newsflash-parent"> 
    <volist name="newsflash" id="vo">
        ...
        <a class="ws-newsflash-cont" href="{$vo.url}" target="_blank">{$vo.title}</a>
...
<!--
<select name="info[sheng]" id="s_province" data-am-selected="{maxHeight: 250,searchBox: 1}">
<option value="品牌">品牌</option>
</select>
<select name="info[shi]" id="s_city" data-am-selected>
...
<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://d1ev.com/uploadfile/ads/<?php echo $infustrydetalist[0]['picName'];?>" alt="<?php echo $infustrydetalist[0]['name'];?>" style="width: 240px;height: 146px;"/>
</div>
</div>
</div>
<div class="blank40"></div>
...
<?php if($qx_bg){?>
    <a class="a1" href="http://d1ev.com/down.php?name=<?php echo $report[0]['title']; ?>&file=<?php echo $report[0]['fj']; ?>" class="ws-report-rightH"><img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://d1ev.com/uploadfile/hysj/<?php echo $report[0]['ylt']; ?>" style ="width: 100px;height: 148px;" alt=""></a>
<?php }else{?>
<a calss="a2" href="" class="ws-report-rightH"><img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://d1ev.com/uploadfile/hysj/<?php echo $report[0]['ylt']; ?>" style ="width: 100px;height: 148px;" alt=""></a>
<?php }?>
</div>
...
<?php }else{?>
<a calss="a2" href="" class="ws-report-rightH"><?php echo $report[0]['title']?></a>
<?php }?>
<div class="ws-report-rightC">
    {$report[0]['summary']|strip_tags|str_cut=###,60}
</div>
</div>
</div>
<div class="blank10"></div>
...
<div class="ws-product-newH">最新产品</div>
<div class="ws-product-newC">
...
<div class="ws-company-newH">最新企业</div>
<div class="ws-company-newC">
...
<div class="hblank40 am-fl"></div>
<div class="ws-content-md am-fl">
<div class="ws-slide">
<div class="slidemodel">
<div class="am-slider am-slider-default" data-am-flexslider id="demo-slider-0">
<ul class="am-slides">
<position action="position" posid="3" num="3" order="listorder DESC" cache="3600">
    <volist name="data" id="vo"><!--焦点图-->
        <li><a href="{$vo.data.url}" target="_blank" title="{$vo.data.title}" class="pic"><img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'"  src="<?php echo src_www_to_img($vo['data']['thumb2'], C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG'));?>" alt="{$vo.data.title}"/><span class="slidecontent">{$vo.data.title}</span></a></li>
    </volist>
</position>
</ul>
</div>
...
<volist name="Recommendnews" key="k" id="vo">
    ...
    <img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="<?php echo src_www_to_img($fullnews[0]['data']['thumb2'], C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG'));?>" alt="<?php echo $fullnews[0]['data']['title'];?>">
    ...
    <span><i class="icon icon-icon_good"></i> {$vo.zan}<?php //echo getZan($vo['id']);?></span>
...
<div class="activity">近期活动</div>
<volist name="all_huodong" id="vo" offset="0" length='2'>
<div class="activity--img">
    <a href="{$vo.url}" target="_blank">
<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="<?php echo src_www_to_img($vo['thumb'], C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG'));?>" alt="{$vo.title}">
</a>
</div>
</volist>
...
<div class="ws-daniu">
<div class="activity--wraped">
<div class="activity">大牛说<a href="http://www.d1ev.com/member/articlenew/publish.html"><i class="icon icon-icon_magzine"></i><span class="activity-textr">我要投稿</span></a></div>
...
<div class="activity--img">
<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://s.amazeui.org/media/i/demos/bing-1.jpg" alt="">
</div>
</div>
</div>
...
<volist name="commentWonderful" id="vo" offset="0" length='3'>
    ...
    <span class="comments--authorpic"><img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-avatar.gif'; ?>'" src="<?php echo src_www_to_img('/d/file/avatar/'. $vo['user_id'] . '/90x90.jpg', C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG')).C('AVATARUPDATETIMESTAMP'); ?>" alt="{$vo['author']}"></span>
    <span>{$vo['author']}</span>
...
<div class="blank40"></div>
<div class="ws-advert">
<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" class="ws-ad-img" src="http://www.d1ev.com/new2016/src/public/images/right01.jpg" alt="">
</div>
<div class="blank40"></div>
<div class="ws-tag">
<div class="ws-common-head">
...
<div class="ws-logo am-container">
	...
	<div class="am-fl am-cf ws-logo-itemC">
		<volist name="vip_company" id="vo">
			...
			<a href="http://d1ev.com/uhome-{$vo.gg_userid}" target="_blank" class="am-fl ws-logo-company">
				<img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://d1ev.com/uploadfile/qytj/{$vo.sy_pic}" alt="{$vo.company}" title="{$vo.company}">
			</a>
			<?php }?>
		</volist>
	</div>
	...
	<a href="http://www.d1ev.com/contents/index/servers" class="ws-logo-btn">
        加入金牌供应商
    </a>
</div>
...
<div class="ws-link am-container">
	<div class="am-cf">
		...
		<?php $links = getLinks(); ?>
			<volist name="links" id="vo" offset="0" length='14'>
				<a href="{$vo.url}" target="_blank" class="am-fl ws-link-item">{$vo.name}</a>
			</volist>
		<a href="http://www.d1ev.com/contents/index/friendlink" class="am-fl ws-link-item">更多</a>
	</div>
...
<!--右侧固定 意见反馈-->
<div class="ws-fixed">
    <div class="ws-fixed-btn" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0, width: 800, height: 404}">
        意见反馈
    </div>
    <div class="ws-fixed-scroll" data-am-smooth-scroll>
        <i class=""></i>
    </div>
            ...
            <form action="http://www.d1ev.com/member/daniusay/add_liuyan" class="am-form"  id="doc-vld-msg" method="post">
                ...
                <div class="dialog--content">
                    ...
                    <div class="tijiao am-cf">
                        ...
                        <a href="javascript:;"><button id="tijiao" class="am-fr tijiao--button">提 交</button></a>
