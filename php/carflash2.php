        ...
        <div class="ws-lastform">
            ...
            <div class="ws-lastform-tabcont">
                <div class="ws-lastform-item ws-lastform-item1">
                    ...
                    <div class="ws-group">
                        <input type="text" placeholder="姓名" class="ws-group-inp">
                    </div>
                    <div class="ws-group">
                        <input type="text" placeholder="手机" class="ws-group-inp">
                    </div>
                    <div class="ws-group am-cf">
                ...
                <div class="ws-lastform-item">
                    <div class="ws-group am-cf" >
                        <select name="" data-am-selected>
                            <option value="1">选品牌</option>
                            <option value="2">选品牌2</option>
                        </select>
                        <select name="" data-am-selected>
                            <option value="43">选车型</option>
                            <option value="5">选车型2</option>
                        </select>
                    </div>
                        <div class="ws-group">
                            <input type="text" placeholder="姓名" class="ws-group-inp">
                        ...
                        <div class="ws-group am-cf">
                            ...
                            <select name="" data-am-selected>
                                <option value="2">选车型</option>
                            </select>
                        </div>

                        <div class="ws-group">
                            <div class="ws-submit1 ws-submit">预约试驾</div>
                        </div>
                    </div>
            </div>
