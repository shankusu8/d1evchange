    ...
    <div class="am-u-lg-fix am-u-md-fix am-u-sm-centered" style="">
        ...
        <form method="post" class="am-form form--padding" id="doc-vld-msg">
            ...
            <div class="am-form-groupa">
                <input type="email" id="email" name="email" value="" placeholder="请输入邮箱" class="am-radius"  data-validation-message="请输入正确的邮箱" required>
           ...
           <input id="submit2" type="button" value="立即注册" class="am-btn am-btn-first am-btn-block">
            <div class="am-cf am-cf--btn">
                <a href="http://www.d1ev.com/member/accountnew/signup"><input type="button" name="" value="使用手机注册" class="am-btn am-btn-links am-btn-sm am-fl"></a>
