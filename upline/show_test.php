...
<div class="ws-content am-container am-cf">
    ...
    <div class="ws-md am-fl">
        <div class="ws-title">
            ...
            <div class="ws-title-infor am-cf">
				...
				<if condition="$zuozhe neq ''">
					...
					<span href="javascript:;" class="am-fl ws-infor-name ws-infor-name1">
                        {$copyfrom}
                    </span>
                    <span href="javascript:;" class="am-fl ws-infor-name ws-infor-name2">
                        {$author}
                    </span>
					</if>
                    <span class="am-fr ws-infor-time">
      ...
      <?php } ?>
        ...
        <div class="page am-pagination ws-pagination">{$pages} <a href="javascript:;">在本页阅读全文</a></div>
      </if>
        <!--点赞-->
        <div class="ws-like<?php echo cookie('liked_'.$id) ? ' liked' : ''; ?>">
			  ...
			  <div class="vehicletype--wraped am-cf">
				...
				<div class="vehicletype--content am-fl">
				  <div class="vehicletype--head">
					...
					<span class="vehicletype_p am-fr">最低参考价：<span class="price">
                                        <if condition="$relation['zuidijia']">{$relation.zuidijia}万<else/>暂无报价</if></span></span>
				  </div>

				  <div class="border--wrapped">
					<div class="am-cf border--wrapper">
					<if condition="$relation['xuhang']">
					  ...
					  </div></if><if condition="$relation['zuigao']">
					  <div class="li--wrapped am-fl">
					  ...
					  </div></if><if condition="$relation['rongliang']['rongliang']">
					  <div class="li--wrapped am-fl">
        ...
        <div class="ws-md-bottom am-cf">
			...
			<volist name="tags" id="vo">
                <a href="{$vo.url}" target="_blank" class="am-fl">{$vo.tag}</a>
			</volist>
            </div>
        ...
        <div class="ws-comment">
            ...
            <div class="duoshuo" id="comment">
                ...
                <!--评论主体-->
                <div id="ds-reset" style="margin: 0px;"></div>
            ...
            <div class="articles--wraped">
				...
				<volist name="relationnews" id="vo">
                    <a href="{$vo.url}"><div class="articles--img first am-fl">
                        <img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="{$vo.thumb}" alt="">
						<div class="ws--about-shadow"></div>
                        <div class="slidecontent">{$vo.title|str_cut=###,33}</div>
                        <!-- <div class="tip"></div> -->
                    </div></a>
					</volist>
                </div>
        ...
        <div class="ws-daniu">
            <div class="wrapper">
                ...
                <div class="authorof--wraped">
					...
					<img class="am-img-thumbnail am-circle" onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-avatar.gif'; ?>'" src="<?php echo src_www_to_img('/d/file/avatar/'. $zuozhe . '/180x180.jpg', C('WEB_SITE_URLS.WWW'), C('WEB_SITE_URLS.IMG')).C('AVATARUPDATETIMESTAMP'); ?>" alt="" width="98" height="98"/>
					</a></div>
                    ...
                    <div class="margin--reset">
                        <div class="am-cf"> 
                            ...
                            <div class="recommend--wrapper am-fl">
                                <a href="http://www.d1ev.com/tag-{$vo.catdir}" class="recommend--img">
                                    <img src="{$vo.image}" alt="">
                                </a>
                                <div class="namer"><a href="http://www.d1ev.com/tag-{$vo.catdir}">{$vo.catname}</a></div>
                            </div>
							</volist>
                            <div class="recommend--wrapper am-fl">
                                <a href="http://www.d1ev.com/choosecar" class="recommend--img">
                                    <img src="http://www.d1ev.com/new2016/src/public/images/chexun.png" alt="">
                                </a>
                                <div class="namer"><a href="http://www.d1ev.com/choosecar">车讯</a></div>
                            </div>
                        </div>
                    </div>
...
<div class="ws-loginModel">
	<div class="ev-container am-container">
		<div class="ev-login-head">
			登录
		</div>
		<div class="wws-close iconfont">&#xe600;</div>
		<div class="ev-form">
			<form action="login.html" method="get" class="am-form">
				<div class="am-form-group ev-form-group">
					<input type="text" class="ev-radius ev-js-name" name="loginName" placeholder="用户名 / 手机号 / 邮箱">
				</div>
				<div class="am-form-group ev-form-group">
					<input type="password" class="ev-radius ev-js-password" name="password" placeholder="密码">
				</div>
				<div class="am-cf ev-aBg">
					<a href="http://www.d1ev.com/member/accountnew/signup" class="am-fl ev-a">注册新用户</a>
					<a href="http://www.d1ev.com/member/accountnew/reset" class="am-fr ev-a" target="_blank">忘记密码?</a>
				</div>
				<button type="button" class="am-btn ev-btn-color ev-js-btn ev-radius am-btn-block">登录</button>
			</form>
			<div class="ev-hr">
				<hr>
				<div>第三方登录</div>
			</div>
			<div class="am-g ev-other-logo">
				<a href="http://www.d1ev.com/index.php?g=member&m=qqlogin&a=qqlogin" class="am-u-sm-4 am-text-center ev-qq iconfont">&#xe608;</a>
				<a href="https://open.weixin.qq.com/connect/qrconnect?appid=wxb6c18a9512fe651a&scope=snsapi_login&redirect_uri=http://www.d1ev.com/member/weixin/login&state=&login_type=jssdk" class="am-u-sm-4 am-text-center ev-weix iconfont" >&#xe60e;</a>
				<a href="http://www.d1ev.com/index.php?g=member&m=weibo&a=index" class="am-u-sm-4 am-text-center ev-weib iconfont">&#xe605;</a>
			</div>
		</div>	
	</div>
</div>
...
<script>
    ...
    function showAll(){
	  $.ajax({
			  type: 'GET',
			  url: "http://www.d1ev.com/Public/getShowAll?id={$id}",
			  dataType: 'jsonp',
			  jsonp:'callback', 
			  cache: false,
			  success: function(json){
			  $('#showall{$randomCode}').fadeIn("slow",function(){
				$('#showall{$randomCode}').html(json['allContent']);
				$('.page').hide();
			  })
			  }
			})
