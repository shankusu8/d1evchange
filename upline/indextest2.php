...
<div class="blank10"></div><div class="ws-banner am-container">
...
<?php }else{?>
<a class="a2" href="javascript:;" class="ws-report-rightH"><img onerror="this.src='<?php echo C('WEB_SITE_URLS.IMG') . '/d/file/default/no-picture.gif'; ?>'" src="http://d1ev.com/uploadfile/hysj/<?php echo $report[0]['ylt']; ?>" style ="width: 100px;height: 148px;" alt=""></a>
<?php }?>
</div>
...
<a href="http://d1ev.com/list_products.php" target="_blank"><div class="ws-common-head">
产品
</div></a>
<div class="blank20"></div>
...
<a href="http://d1ev.com/list_companys.php" target="_blank"><div class="ws-common-head">
企业
</div></a>
<div class="blank20"></div>
...
<div class="ws-tag">
<a href="http://www.d1ev.com/alltags" target="_blank"><div class="ws-common-head">
热门标签
</div></a>
<div class="blank20"></div>
...
<div class="ws-modal">
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
        <div class="am-modal-dialog">
            <form action="http://www.d1ev.com/member/daniusay/add_liuyan" method="post" class="am-form"  id="doc-vld-msg">
